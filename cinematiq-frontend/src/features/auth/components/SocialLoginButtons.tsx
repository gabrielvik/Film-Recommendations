...
const SocialLoginButtons = ({ onSuccess, className }: SocialLoginButtonsProps) => {
  ...
  const handleFacebookLogin = async () => {
    ...
    try {
      ...
      await loginWithFacebook('mock_facebook_token');
      onSuccess?.();
    } catch (error) {
  ...
  return (
    <div className={className}>
      {/* Social Error */}
      {socialError && (
        <div className="flex items-center space-x-2 text-red-600 text-sm bg-red-50 p-3 rounded-md mb-4">
